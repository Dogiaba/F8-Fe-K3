  ...
  return (
    ...
    <div className="container bg-slate-700 p-4 flex flex-col flex bg-warning bg-gradient">
        <div className="mx-auto w-full max-w-3xl px-4 py-6 ">
            ...
            <form className="pagination justify-content-center" >
                <div className="flex items-center border-b  py-2">
                    <input  id="task" name="task" type='text'  placeholder='Thêm một việc làm mới' className=" bg-transparent px-2 w-full mr-3 py-1  focus:outline-none text-white h5 pb-2 mb-4 inputBtn" autoFocus/>
