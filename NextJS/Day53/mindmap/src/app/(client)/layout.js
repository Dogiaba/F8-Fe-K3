...
const layout = async ({ children }) => {
  ...
  return (
    <>
      <header className=" header flex h-[64px] border-b bg-background z-50 sticky top-0 w-full text-black dark:bg-slate-900 dark:text-white ">
        <div className="nav-logo flex">
          <Link className="mx-4 font-bold text-amber-500" href="/">
            MINDMAP
          </Link>
          <h4>Mind Map Flow</h4>
        ...
        <div className="nav-left">
          <ul className="flex items-center">
            ...
            <li>
              <Link className="mx-4" href="/features">
                Tính năng
              </Link>
            </li>
            <li>
              <Link className="mx-4" href="/price">
                Bảng Giá
              </Link>
            </li>
            <li>
