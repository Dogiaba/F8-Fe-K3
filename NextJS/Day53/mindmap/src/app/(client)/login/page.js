        ...
        <div class="w-full flex-1 mt-8">
          <div class="flex flex-col items-center">
            <button onClick={() => signIn("google",{callbackUrl:`${process.env.NEXT_PUBLIC_NEXTAUTH_URL}/mindmaps`})} class="w-full max-w-xs font-bold shadow-sm rounded-lg py-3 bg-indigo-100 text-gray-800 flex items-center justify-center transition-all duration-300 ease-in-out focus:outline-none hover:shadow focus:shadow-sm focus:shadow-outline">
              ...
              <span className="ml-4">Sign Up with Google(Bảo Trì)</span>
            </button>
            ...
            <button onClick={()=> signIn("auth0",{callbackUrl:`${process.env.NEXT_PUBLIC_NEXTAUTH_URL}/mindmaps`})} className="w-full max-w-xs font-bold shadow-sm rounded-lg py-3 bg-indigo-100 text-gray-800 flex items-center justify-center transition-all duration-300 ease-in-out focus:outline-none hover:shadow focus:shadow-sm focus:shadow-outline mt-5">
              <div className="bg-white p-1 rounded-full">
              <SiAuth0 />
              </div>
              <span className="ml-4">Sign Up with Auth0</span>
